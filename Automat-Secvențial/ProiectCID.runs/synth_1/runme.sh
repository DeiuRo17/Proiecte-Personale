...
HD_PWD='C:/Users/botaa/ProiectCID/ProiectCID.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnt3b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnt3b.tcl
